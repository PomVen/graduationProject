...
//    // 获取word文档标题
//    public List<String> getWordTitles(String filepath) throws IOException {
...
//    }
    ...
    // 获取word文档内容
    public String getWordText(String filepath) throws Exception {
        String filename = getWordVersion(filepath);
        if (".docx".equals(filename)) {
     ...
     * @throws IOException
     */
    public String getWordTitlesAndContext2003(String path, Integer type){
        InputStream is = null;
...
//        }
    ...
    public String getWordTitles2007(String path){
...
//                    System.out.println(para.getText().trim());
    ...
    // 获取2007版word文档内容
    public static String getParagraphText2007(String filePath) throws Exception {
