...
<div class="beg-login-box box box-reset layui-anim-up" id="reset">
    <header>
        <h1 style="color:#FFFFFF">重置密码</h1>
    </header>
    <div class="beg-login-main">
        <form action="/login/resetPassword" class="layui-form" method="post"><input name="__RequestVerificationToken" type="hidden" value="fkfh8D89BFqTdrE2iiSdG_L781RSRtdWOH411poVUWhxzA5MzI8es07g6KPYQh9Log-xf84pIR2RIAEkOokZL3Ee3UKmX0Jc8bW8jOdhqo81" />
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe612;</i>
                </label>
                <input id="resetUserName" type="text" name="resetUserName" lay-verify="resetUserName" autocomplete="off" placeholder="请输入用户名" class="layui-input" required>
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe6b2;</i>
            ...
            <div class="layui-form-item">
                ...
                <input id="resetPassword" type="password" name="resetPassword" lay-verify="resetPassword" autocomplete="off" placeholder="请输入重置密码" class="layui-input" required>
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe642;</i>
                </label>
                <input id="resetPasswordCheck" type="password" name="resetPasswordCheck" lay-verify="resetPasswordCheck" autocomplete="off" placeholder="确认密码" class="layui-input" required>
            </div>
            <div class="layui-form-item">
