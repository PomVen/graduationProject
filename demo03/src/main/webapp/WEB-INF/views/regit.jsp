    ...
    <div class="beg-login-main">
        <form action="/login/userRegit" class="layui-form" method="post">
            ...
            <div class="layui-form-item">
                ...
                <input id="regitUserName" type="text" name="regitUserName" lay-verify="regitUserName" autocomplete="off" placeholder="请输入用户名" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe642;</i>
                </label>
                <input id="regitPassword" type="password" name="regitPassword" lay-verify="regitPassword" autocomplete="off" placeholder="请输入密码" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe642;</i>
                </label>
                <input id="regitPasswordCheck" type="password" name="regitPasswordCheck" lay-verify="regitPasswordCheck" autocomplete="off" placeholder="确认密码" class="layui-input">
            </div>
            <div class="layui-form-item">
                <label class="beg-login-icon">
                    <i class="layui-icon">&#xe6b2;</i>
